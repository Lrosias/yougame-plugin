---
description: Make this game YouGame-ready, check it, and zip it for upload (or, with YOUGAME_API_KEY set, upload it and fill in the listing for review)
...
folder's contents. If `YOUGAME_API_KEY` is set, upload the zip, fill in every listing field
